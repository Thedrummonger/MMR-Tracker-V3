...
namespace Windows_Form_Frontend
{
    public partial class PopoutPathfinder : Form
    {
        ...
        {
            var AccessableAreas = _instance.EntrancePool.AreaList.Values.Where(x => x.ExitsAcessibleFrom > 0 && (x.LoadingZoneExits.Any() || _instance.StaticOptions.ShowMacroExitsPathfinder)).Select(x => x.ID);
